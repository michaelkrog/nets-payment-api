...
/**
 * Defines a PSIPHeader.<br>
 * The ‘PGTM Routing Header’ (‘Payment Gateway Transaction Monitor Routing Header’) is a header used by Nets ‘Payment Gateway’<br>
 * for internal routing. The merchant server uses the PGTM routing header to verify the status of the networking connection by<br>
 * checking the network response code.<br>
 * <br>
 * In case the network response code is '0000', the application should proceed to verify the status of the authorisation/capture in
 * PSIP header.
 */
