...
public class Nets {
    ...
    public NetsResponse refund(Merchant merchant, Card card, Money money, String orderId, boolean recurring, String terminalId, String approvalCode, ActionCode actionCode) throws IOException {
        Validate.notNull(merchant, "merchant must be specified");
        Validate.notNull(card, "card must be specified");
        Validate.notNull(money, "money must be specified");
        Validate.notNull(orderId, "orderId must be specified");
        ...
        String expire = expireFormat.format(card.getExpireYear()) + expireFormat.format(card.getExpireMonth());
        String pointOfService = recurring ? "K00540K00130" : "K00500K00130";
        String function = FunctionCode.Capture_Original_Transaction.getCode();
    ...
    public NetsResponse capture(Merchant merchant, Card card, Money money, String orderId, boolean recurring, String terminalId, String approvalCode, ActionCode actionCode, boolean amountDiffers) throws IOException {
        Validate.notNull(merchant, "merchant must be specified");
        Validate.notNull(card, "card must be specified");
        Validate.notNull(money, "money must be specified");
        Validate.notNull(orderId, "orderId must be specified");
